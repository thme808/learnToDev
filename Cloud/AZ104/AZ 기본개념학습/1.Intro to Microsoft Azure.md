...
![](1.Intro%20to%20Microsoft%20Azure/B7E4BA8F-967F-4001-A958-2D2F9C2529AF%202.png)

![](1.Intro%20to%20Microsoft%20Azure/409DC9A6-FCE0-4E3B-8B8B-EFE2C8918F62%202.png)

### Entra ID 와 AD Domain Service (on-prem)
**Entra ID**
- Entra ID 는 클라우드(인터넷) 상에서 제공되는 서비스
- it works over HTTPS or works on Internet 
- oauth 2, OIDC(open id connect), saml 등 을 이용해 identity를 확인함

**AD DS (on-premise)**
- 온프레미스 AD는 기업내부의 private network 에서 동작함
- kereberos, NTLM, LDAP 등의 기술을 사용
...
![](1.Intro%20to%20Microsoft%20Azure/3F267E24-C3FD-4A3B-89B0-937FC9E5D276%202.png)
...
![](1.Intro%20to%20Microsoft%20Azure/1999C94E-A42E-42AD-A0FD-FA90EE35341E%202.png)
...
그룹으로 분산된다
![](1.Intro%20to%20Microsoft%20Azure/3A196768-ABB4-42F6-BE23-B26DD7494879%202.png)

![](1.Intro%20to%20Microsoft%20Azure/9682A6A1-347D-42D6-9373-FB3418AC7C58%202.png)
...
1. User 생성
![](1.Intro%20to%20Microsoft%20Azure/5504605C-0828-4526-BAD3-B43E671C4CAA%202.png)
![](1.Intro%20to%20Microsoft%20Azure/09141699-EB11-4381-9375-2912DD74404E%202.png)
2. subscription 에 관리 위임
![](1.Intro%20to%20Microsoft%20Azure/2F058E8B-0801-47D0-9F88-F296A09D41DD%202.png)
3. global admin 역할 부여
![](1.Intro%20to%20Microsoft%20Azure/004AF13B-EFF6-4D91-8B3B-BB6E606BD1EB%202.png)
4. owner 역할 부여
![](1.Intro%20to%20Microsoft%20Azure/9E73827A-96E9-4D35-A654-064635AC5BBB%202.png)

![](1.Intro%20to%20Microsoft%20Azure/8A9C8127-76A1-4C79-B56B-DB605449CD16%202.png)
![](1.Intro%20to%20Microsoft%20Azure/F605EB1A-B9F5-4E66-B95E-881487F74FA5%202.png)
![](1.Intro%20to%20Microsoft%20Azure/7DA2B433-8C00-485F-8238-05767A4886D5%202.png)

5. adminuser 계정으로 로그인
![](1.Intro%20to%20Microsoft%20Azure/E90FAA99-7889-470B-9E89-06DA8C38CCB8%202.png)

### Resource group 
1. region은 변경 불가하므로 잘 선택해야함.
![](1.Intro%20to%20Microsoft%20Azure/C4B64166-6607-40CE-B838-1D0D3B1541BA%202.png)
![](1.Intro%20to%20Microsoft%20Azure/5DDACA51-4811-46F6-BFD1-3023982FC899%202.png)

- Resource Group에 role 부여
![](1.Intro%20to%20Microsoft%20Azure/724C4E3C-B567-4CCD-AD21-24C032631E90%202.png)
- Resource Group에 개별 멤버, 혹은 group을 매핑함 
![](1.Intro%20to%20Microsoft%20Azure/CA30D916-C4BD-4E59-805D-EA7418A4857F%202.png)
...
![](1.Intro%20to%20Microsoft%20Azure/4918BC7B-CF99-4D8C-ADC9-5BD975CB4A8C%202.png)
- korea central 지역에만 배포하도록 제한
	- 메세지 처리 “Region은 korea central만 가능함”
![](1.Intro%20to%20Microsoft%20Azure/A3764971-58FD-4193-B423-58BC0B044BC0%202.png)

![](1.Intro%20to%20Microsoft%20Azure/32886E33-4E67-4F29-9283-7D29648E7C99%202.png)

- 신규 정책 적용된 것 확인 
![](1.Intro%20to%20Microsoft%20Azure/A8CF967B-1B32-4037-90B6-B3550D54B1C7%202.png)
- korea central 외 다른 region으로 vm 생성시 아래 에러 발생함
![](1.Intro%20to%20Microsoft%20Azure/9C99BBA6-EE09-47B1-A2FF-79D9ADD08615%202.png)
...
![](1.Intro%20to%20Microsoft%20Azure/BD18D0E2-11F7-42B6-887A-130E7142E3F3%202.png)
- az group list -o table
	- output table option 주면 테이블 형식으로 출력
![](1.Intro%20to%20Microsoft%20Azure/0AA255A5-7C4E-4941-AD82-01F0CFA94D77%202.png)

![](1.Intro%20to%20Microsoft%20Azure/EC08F4EA-1E4E-4F1C-96BF-92BB2C8AA7A2%202.png)

![](1.Intro%20to%20Microsoft%20Azure/C3D50941-3347-4B14-A036-5757AE37AB10%202.png)
